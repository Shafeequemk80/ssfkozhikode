                  ...
                  <div key={index}>
                    <div className="relative border-8 border-[#c7d9a7] h-[350px] w-[350px] drop-shadow">
                      ...
                      >
                        ...
                        >
                          <div
                            className={`text-[10px] roboto-regular ${color[index]}`}
                          >
                            Category Name
                          </div>
                          <div
                            className={`text-[15px] font-fractul roboto-bold  -mt-[6px] ${color[index]}`}
                          >
                            item Name
                          </div>
                          ...
                          <div className="mt-2 pl-[10px] text-start">
                            {[...Array(3)].map((_, idx) => (
                              <div key={idx}>
                                <div
                                  className={`text-[13px] roboto-medium ${color[index]}`}
                                >
                                  Participants Name
                                </div>
                                <div
                                  className={`text-[8px] -mt-[3px] mb-[6px] roboto-regular ${color[index]}`}
                                >
                                  Participants Team
                                </div>
                              </div>
