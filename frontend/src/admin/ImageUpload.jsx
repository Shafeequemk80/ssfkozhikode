                  ...
                  <div key={index}>
                    <div className="relative border-8 border-[#c7d9a7] h-[350px] w-[350px] drop-shadow">
                      ...
                      >
                        ...
                        >
                          <div
                            className={`text-[10px] montserrat-semibold  ${color[index]}`}
                          >
                            Category Name
                          </div>
                          <div
                            className={`text-[15px] montserrat-bold -mt-[6px]   -mt-[6px] ${color[index]}`}
                          >
                            item Name
                          </div>
                          ...
                          <div className="mt-2 pl-[10px] text-start">
                            {[...Array(3)].map((_, idx) => (
                              <div key={idx}>
                                <div
                                  className={`text-[12px] montserrat-bold ${color[index]}`}
                                >
                                  Participants Name
                                </div>
                                <div
                                  className={`text-[10px] -mt-[5px] mb-[6px] montserrat-regular ${color[index]}`}
                                >
                                  Participants Team
                                </div>
                              </div>
